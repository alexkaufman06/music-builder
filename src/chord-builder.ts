import {diminishedChordPattern, dominant7ChordPattern, major7ChordPattern, majorChordPattern,
  minor7ChordPattern, minor7flat5ChordPattern, minorChordPattern} from "./common/chords";
